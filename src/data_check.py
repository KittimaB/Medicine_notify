...
"background-color: rgb(166, 0, 0)")
        ...
        self.label_4.setGeometry(QtCore.QRect(220, 170, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_2.setGeometry(QtCore.QRect(80, 110, 231, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.drugDescribe_label.setGeometry(QtCore.QRect(30, 140, 81, 21))
        font = QtGui.QFont()
        ...
        self.drugAll_label.setGeometry(QtCore.QRect(30, 170, 171, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.drugAll_label.setFont(font)
        self.drugAll_label.setObjectName("drugAll_label")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(120, 140, 191, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.drugName_label.setGeometry(QtCore.QRect(30, 110, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.drugName_label.setFont(font)
        self.drugName_label.setObjectName("drugName_label")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(220, 200, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.drugOne_label.setGeometry(QtCore.QRect(30, 200, 181, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.next_pushButton.setGeometry(QtCore.QRect(420, 300, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
...
"")
        ...
        self.label_7.setGeometry(QtCore.QRect(220, 260, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_6.setGeometry(QtCore.QRect(220, 230, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.drugNew.setGeometry(QtCore.QRect(30, 230, 181, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.drugNew.setFont(font)
        self.drugNew.setObjectName("drugNew")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(220, 320, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.day_start.setGeometry(QtCore.QRect(30, 320, 181, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.day_start.setFont(font)
        self.day_start.setObjectName("day_start")
        self.listWidget = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget.setGeometry(QtCore.QRect(340, 140, 181, 131))
        font = QtGui.QFont()
        ...
        self.select_meal_label.setGeometry(QtCore.QRect(340, 110, 181, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, data_check):
        ...
        self.next_pushButton.setText(_translate("data_check", "เสร็จสิ้น"))
        self.drugStill.setText(_translate("data_check", "จำนวนยาคงเหลือ (เม็ด) :"))
        ...
        self.select_meal_label.setText(_translate("data_check", "มื้อยาที่รับประทานประกอบด้วย"))
